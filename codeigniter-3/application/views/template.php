...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SIMANSE</b> SD 83</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?= base_url() ?>assets/back/dist/img/fotolala3.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?= base_url() ?>assets/back/dist/img/fotolala3.jpg" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li herf=<?=$this->uri->segment(1) == 'admin' ? 'class="active"' :''?>>
        ...
        <li class="treeview">
          ...
          <li herf=<?=$this->uri->segment(1) == 'guru' ? 'class="active"' :''?>>
            <a href="<?=site_url('guru')?>"><i class="fa fa-circle-o"></i> Guru</a></li>
          <li herf=<?=$this->uri->segment(1) == 'siswa' ? 'class="active"' :''?>>
            <a href="<?=site_url('siswa')?>"><i class="fa fa-circle-o"></i> Siswa</a></li>
          </ul>
        </li>
        
        <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Data Sekolah</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <li herf=<?=$this->uri->segment(1) == 'data_guru' ? 'class="active"' :''?>>
            <a href="<?=site_url('data_guru')?>"><i class="fa fa-circle-o"></i> Data Guru</a></li>
            <li herf=<?=$this->uri->segment(1) == 'data_siswa' ? 'class="active"' :''?>>
            <a href="<?=site_url('data_siswa')?>"><i class="fa fa-circle-o"></i> Data siswa</a></li>
            <li herf=<?=$this->uri->segment(1) == 'data_ruangan' ? 'class="active"' :''?>>
            <a href="<?=site_url('data_ruangan')?>"><i class="fa fa-circle-o"></i> Data Ruangan</a></li>
          </ul>
        </li>
